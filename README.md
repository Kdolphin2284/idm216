...
```
- Notice how in the above example, the h1 and h3 are both indented with one tab, since they are inside of the div. The h3 and h1 are not children of one another, so they sit in line with each other. The last div tag sits one tab back from the h1 and h3, as well as in line with the cooresponding div tag. This is beccause it closes that "block" of code.
