...
<?php
    ...
    if ($result-> num_rows > 0) {
        while ($row = $result-> fetch_assoc()) {
            ...
            $hs_price = htmlspecialchars($row['price'], ENT_QUOTES);
            $hs_blurb = htmlspecialchars($row['blurb'], ENT_QUOTES);
    ...
    <section id="updateDbInfo">
        ...
        <div class="contentContainer">
            <form action="../includes/updateInfo.php" method="POST" class="dbInfoAddForm">
                ...
                <field class="directionsField">
                    <label for="price">Price - <span>Integer starting with $ and ending in two decimal points</span></label>
                    <textarea id="price" name="price" rows="5" cols="50"><?php echo $hs_price; ?></textarea>
                </field>
                <field class="directionsField">
                    <label for="blurb">Blurb - <span>Short description of food item</span></label>
                    <textarea id="blurb" name="blurb" rows="5" cols="50"><?php echo $hs_blurb; ?></textarea>
                </field>
                <field class="directionsField">
                        <label for="fileUpload">Upload Hero Image</label>
                        <input type="file" name="fileUpload" onchange="updateBase64()" />
                        <input type="hidden" id="base64Image" name="base64Image" value='<?php echo $hs_hero; ?>'/>
                </field>
