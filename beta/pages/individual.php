                ...
                <section id="order-customization-section">
                    ...
                    <div class="customization-category">
                        ...
                        for($i = 0; $i<sizeof($hs_base); $i++){
                            ...
                            ?>
                                <?php
                                    echo "<button class='food_choice base' onclick='btnToggle(event)'><p>$base</p></button>";
                                ?>
                            <?php
                        }
                        ?>
                            ...
                            <div class="customization-category">
                                ...
                                for($i = 0; $i<sizeof($hs_protein); $i++){
                                    ...
                                    if (sizeof($protein_with_price) > 1) {
                                        echo "<button class='food_choice protein' onclick='btnToggle2(event)'><p>" . $protein_with_price[0] . "</p><p>" . $protein_with_price[1] . "</p></button>";
                                        continue;
                                }
                                    ?>
                                        <?php
                                            echo "<button class='food_choice protein' onclick='btnToggle2(event)'><p>" . $protein . "</p></button>";
                                        ?>
                                    <?php
                                }
                                ?>
                    ...
                    <div class="customization-category">
                        ...
                        for($i = 0; $i<sizeof($hs_more); $i++){
                            ...
                            ?>
                                <?php
                                    echo "<button class='food_choice' onclick='btnMulti2(event)'><p>$more</p></button>";
                                ?>
                            <?php
                        }
                        ?>
                    ...
                    <div class="customization-category">
                        ...
                        for($i = 0; $i<sizeof($hs_toppings); $i++){
                            ...
                            ?>
                                <?php
                                    echo "<button class='check-btn' onclick='btnMulti(event)'>
                    ...
                    <div class="customization-category">
                        ...
                        for($i = 0; $i<sizeof($hs_drinks); $i++){
                            ...
                            ?>
                                <?php
                                    echo "<button class='food_choice' onclick='btnMulti2(event)'><p>$drinks</p></button>";
                                ?>
                            <?php
                        }
                        ?>
                    ...
                    <div class="customization-category">
                        ...
                        for($i = 0; $i<sizeof($hs_sides); $i++){
                            ...
                            ?>
                                <?php
                                    echo "<button class='food_choice' onclick='btnMulti2(event)' ><p>$sides</p></button>";
                                ?>
                            <?php
                        }
                        ?>
